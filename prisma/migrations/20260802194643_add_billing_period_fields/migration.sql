-- AlterTable
ALTER TABLE "Transaction" ADD COLUMN "billingMonth" INTEGER;
ALTER TABLE "Transaction" ADD COLUMN "billingReference" TEXT;
ALTER TABLE "Transaction" ADD COLUMN "billingYear" INTEGER;
ALTER TABLE "Transaction" ADD COLUMN "estimatedDueDate" DATETIME;
